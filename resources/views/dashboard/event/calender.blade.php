@extends('dashboard.event.layouts')
@section('content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="create_event_frm" action="{{route('event')}}" method="post" enctype="multipart/form-data">
                        ...
                        {{--                                                    <div class="col-md-12">--}}
                        {{--                                                        <div class="form-group">--}}
                        {{--                                                            <select class="form-control" id="podium" name="podium" placeholder="Podium">--}}
                        ...
                        <div class="stage-form">
                            @csrf
                            <div class="form-group">
                                <input autocomplete="off" type="text" name="stage_id" id="stage_id" class="form-control"
                                       placeholder="Enter podium"/>
                                <div id="countryList">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pull-left" style="width: 75%;">
                                <div class="col-lg-5 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="event_start_date" required id="edit_event_start_date"
                                               value="" class="form-control date_pick" placeholder="Start Date">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-xs-2">
...
@section('content_script')
    ...
    <script>
        var loader = '<img class="loader" src="<?php echo asset('img/loader.gif')?>"/>';
